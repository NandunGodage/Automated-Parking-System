...
echo '<link rel="stylesheet" type="text/css" href="../css/paymentsuccess.css">';
echo '<script src="../js/paymentsuccess.js"></script>';
echo '';
echo '</head>';
echo '<body>';
echo '';
...
echo '</svg>';
echo '<h1 class="success-message__title">Payment successful!</h1>';
echo '<div class="success-message__content">';
echo '<p> </p>';
echo '</div>';
echo '</div>';
echo '';
