...
echo '<img class="logoImage" src="..\images\phone.png">';
echo '<h2> 011-xxxxxxx </h2>';
echo '<h2> 011-22xxxxx </h2>';
echo '';
echo '</div>';
echo '';
echo '';
echo '<div class="column">';
echo '<img class="logoImage" src="..\images\mail.png">';
echo '<h2> safeparking@email.com </h2>';
echo '';
echo '</div>';
echo '';
echo '';
echo '<div class="column">';
echo '<img class="logoImage" src="..\images\twiter icone.png">';
echo '<h2> Safe Paking </h2>';
echo '</div>';
echo '';
echo '</div>';
echo '';
