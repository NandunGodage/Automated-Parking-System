...
echo '<link rel="stylesheet" type="text/css" href="../css/help&support_admin.css">';
echo '';
echo '</head>';
echo '<body>';
...
echo '</tr>';
echo '<tr>';
echo '<td>Kamal Perera</td>';
echo '<td>@mail.com</td>';
echo '<td>**text</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Pratish Jeyaraj</td>';
echo '<td>@mail.com</td>';
echo '<td>**text</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Ishan Chan</td>';
echo '<td>@mail.com</td>';
echo '<td>**text</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Mohommad Rizwan</td>';
echo '<td>@mail.com</td>';
echo '<td>**text</td>';
echo '</tr>';
echo '</table>';
